...
function Stories({setShowStory, storyId, setShowAddStory}) {
  ...
  return (
    <div className='stories-container' >
      <div className="story-wrapper-box" >
        <div className="add-story-btn common-width" onClick={()=>setShowAddStory(true)} >
      ...
      </div>
      {
        data.map((data) => {
          return (
            <div className="story-wrapper-box" onClick={()=>setShowStory(true)} >
