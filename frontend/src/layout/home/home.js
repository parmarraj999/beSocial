...
function Home() {
  ...
  const [currentPostSection, setCurrecntPostSection] = useState("All")
  ...
  const handleGetAllPost = async () => {
    const response = await axios.post("https://besocial-q86i.onrender.com/getAllPosts")
      .then((result) => {
  ...
  return (
    <div className='home-container' >
      ...
      <div className='nav4logo' >
        <div>
          <img style={{ width: "60px" }} src="../../../../image/besocial-logo-2.png" />
        </div>
        <div style={{ display: "flex", gap: '1rem' }}>
          <Link to="/notification">
            <svg className='nav-icon' style={{ color: "black" }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M5 18H19V11.0314C19 7.14806 15.866 4 12 4C8.13401 4 5 7.14806 5 11.0314V18ZM12 2C16.9706 2 21 6.04348 21 11.0314V20H3V11.0314C3 6.04348 7.02944 2 12 2ZM9.5 21H14.5C14.5 22.3807 13.3807 23.5 12 23.5C10.6193 23.5 9.5 22.3807 9.5 21Z"></path></svg>
          </Link>
          {/* <Link to="/community">
            <svg style={{color:"black"}} className='nav-icon upIconAnime' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M10.6144 17.7956C10.277 18.5682 9.20776 18.5682 8.8704 17.7956L7.99275 15.7854C7.21171 13.9966 5.80589 12.5726 4.0523 11.7942L1.63658 10.7219C.868536 10.381.868537 9.26368 1.63658 8.92276L3.97685 7.88394C5.77553 7.08552 7.20657 5.60881 7.97427 3.75892L8.8633 1.61673C9.19319.821767 10.2916.821765 10.6215 1.61673L11.5105 3.75894C12.2782 5.60881 13.7092 7.08552 15.5079 7.88394L17.8482 8.92276C18.6162 9.26368 18.6162 10.381 17.8482 10.7219L15.4325 11.7942C13.6789 12.5726 12.2731 13.9966 11.492 15.7854L10.6144 17.7956ZM4.53956 9.82234C6.8254 10.837 8.68402 12.5048 9.74238 14.7996 10.8008 12.5048 12.6594 10.837 14.9452 9.82234 12.6321 8.79557 10.7676 7.04647 9.74239 4.71088 8.71719 7.04648 6.85267 8.79557 4.53956 9.82234ZM19.4014 22.6899 19.6482 22.1242C20.0882 21.1156 20.8807 20.3125 21.8695 19.8732L22.6299 19.5353C23.0412 19.3526 23.0412 18.7549 22.6299 18.5722L21.9121 18.2532C20.8978 17.8026 20.0911 16.9698 19.6586 15.9269L19.4052 15.3156C19.2285 14.8896 18.6395 14.8896 18.4628 15.3156L18.2094 15.9269C17.777 16.9698 16.9703 17.8026 15.956 18.2532L15.2381 18.5722C14.8269 18.7549 14.8269 19.3526 15.2381 19.5353L15.9985 19.8732C16.9874 20.3125 17.7798 21.1156 18.2198 22.1242L18.4667 22.6899C18.6473 23.104 19.2207 23.104 19.4014 22.6899ZM18.3745 19.0469 18.937 18.4883 19.4878 19.0469 18.937 19.5898 18.3745 19.0469Z"></path></svg>
          </Link> */}
        </div>
      </div>

      <div className='tag-container' >
        <div className={currentPostSection === "All" ? "tag-active" : "tag"} onClick={() => setCurrecntPostSection("All")} >All</div>
        <div className={currentPostSection !== "All" ? "tag-active" : "tag"} onClick={() => setCurrecntPostSection("Following")} >Following</div>
      </div>
      ...
      {
        currentPostSection === "All" ?
          <AllPost setOnePost={setOnePost} setShowDetail={setShowDetail} handleGetPost={handleGetPost} data={allData} /> :
      ...
      < div className='post-create-btn-home' onClick={() => {
        userData.setShowCreateVar(true)
