...
function Signup({setForm}) {
  ...
  return (
    ...
    <div className='form-box'>
        ...
        <form>
            <input placeholder='Name' type="text" className='' name="lname" />
            <input placeholder='Email' type="text" className='' name="lname" />
            <input placeholder='Password' type="Password" className='' name="lname" />
            <input placeholder='Confirm Password' type="Password" className='' name="lname" />

            <div className='form-submit'>
                <button className='one-btn'>Create Account</button>
            </div>
